...
def call_function(
 ...
 Sample API endpoint https://playstation-beta.domo.com/api/codeengine/v2/packages/13b0d518-58f5-42b5-bbb9-a64e98dcb803/versions/1.0.2/functions/who_am_i
 Sample Input variables object #{"domo_instance":"playstation-beta","auth_name":"OZ","debug_api":False} """
